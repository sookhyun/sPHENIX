...
class MyJetAnalysis : public SubsysReco
{
 public:
  MyJetAnalysis(
      const std::string &calojetname = "AntiKt_Tower_r04",
      const std::string &pfjetname = "",
 ...
 private:
  ...
  float m_tj_eta = std::numeric_limits<float>::signaling_NaN();
  float m_tj_phi = std::numeric_limits<float>::signaling_NaN();
  float m_tj_e = std::numeric_limits<float>::signaling_NaN();
  float m_tj_pt = std::numeric_limits<float>::signaling_NaN();  

  float m_rcj_eta = std::numeric_limits<float>::signaling_NaN();
  float m_rcj_phi = std::numeric_limits<float>::signaling_NaN();
  float m_rcj_e = std::numeric_limits<float>::signaling_NaN();
  float m_rcj_pt = std::numeric_limits<float>::signaling_NaN();
  float m_rcj_dist = std::numeric_limits<float>::signaling_NaN();

  float m_rpj_eta = std::numeric_limits<float>::signaling_NaN();
  float m_rpj_phi = std::numeric_limits<float>::signaling_NaN();
  float m_rpj_e = std::numeric_limits<float>::signaling_NaN();
  float m_rpj_pt = std::numeric_limits<float>::signaling_NaN();
  float m_rpj_dist = std::numeric_limits<float>::signaling_NaN();
